    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "hover:bg-slate-50 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-slate-100 transition-colors",
        ...
        head_row: "flex",
        head_cell: "text-slate-400 dark:text-slate-500 rounded-md w-9 h-8 font-medium text-[0.75rem] flex items-center justify-center",
        row: "flex w-full mt-1",
        cell: "relative w-9 h-9 flex items-center justify-center p-0 text-sm",
        day: cn(
          "w-9 h-9 rounded-full font-normal text-slate-800 dark:text-slate-200 transition-colors",
        ...
        day_outside: "text-slate-300 dark:text-slate-600 hover:bg-transparent hover:text-slate-300 pointer-events-none",
        day_disabled: "text-slate-300 dark:text-slate-600 line-through cursor-not-allowed opacity-40 hover:bg-transparent hover:text-slate-300",
